...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { category_id: @merchant.category_id, product_id: @merchant.product_id }
    end
  ...
  test "should update merchant" do
    patch :update, id: @merchant, merchant: { category_id: @merchant.category_id, product_id: @merchant.product_id }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
